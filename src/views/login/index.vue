    ...
    export default {
      ...
      data() {
        ...
        return {
          ...
          loginRules: {
            username: [
              { required: true, message: '请输入账号', trigger: 'blur', pattern:'^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,12}$'},
              { min: 6, max: 12, message: '请输入正确帐号', trigger: 'blur' },
              { pattern:'^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,12}$', message: '密码错误', trigger: 'blur' },
            ],
            password: [
              { required: true, message: '请输入密码', trigger: 'blur', minlength: 6, maxlength: 12,  },
              { min: 6, max: 12, message: '请输入6～12位正确密码', trigger: 'blur' },
              { pattern:'^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,12}$', message: '密码错误', trigger: 'blur' }
            ]
          },
          loading: false,
