<template>
    <div class="dashboard-editor-container">
        <div class=" clearfix">
            ...
            <a href="http://git.oschina.net/MyCODE11/vue-element-admin" target="_blank" class="github-corner" aria-label="View source on Github">
        ...
        <div class="btn-group">
            <router-link class="pan-btn blue-btn" to="/example/ShippingDateTable">船期大厅</router-link>
            <router-link class="pan-btn light-blue-btn" to="/charts/index">进口查询</router-link>
            <router-link class="pan-btn red-btn" to="/example/exportTable">出口查询</router-link>
            <router-link class="pan-btn pink-btn" to="/excel/download">导出excel</router-link>
            <router-link class="pan-btn green-btn" to="/example/table">业务历史</router-link>
            <router-link class="pan-btn tiffany-btn" to="/example/LoadExcel">模板下载</router-link>
        </div>
        ...
        <div class="clearfix main-dashboard-container">
            ...
            <div class="recent-articles-container">
                ...
                <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                    <el-form :inline="true">
                        <el-form-item>
                            <el-input  size="small" v-model="filters.name" placeholder="船名"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-input  size="small" v-model="filters.importVoyage" placeholder="航次"></el-input>
                        </el-form-item>
                        <el-form-item>
                ...
                <div style="background-color:#fff;padding-right:10px;">
                    <el-table :data="tableData3" stripe height="380" border style="font-size:10px"  align="center">
                        <el-table-column prop="trafName" label="船名" >
                        </el-table-column>
...
<script>
    import { getShipName } from '../../../api/api';
      ...
      methods: {
        ...
        getUsers() {
            let para = {
                ...
                importVoyage: this.filters.importVoyage
            };
