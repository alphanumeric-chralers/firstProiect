...
/*work*/
//const ShippingDateTable = resolve => require(['../views/work/ShippingDateTable.vue'], resolve);
//const LoadExcel = resolve => require(['../views/work/LoadExcel.vue'], resolve);
...
const LoadExcel = resolve => require(['../views/example/loadExcel'], resolve);
const Form1 = resolve => require(['../views/example/form1'], resolve);
const ShippingDateTable = resolve => require(['../views/example/shippingDateTable'], resolve);
const exportTable = resolve => require(['../views/example/exportTable'], resolve);
const Hello = resolve => require(['../views/example/Hello'], resolve);
...

        {
          ...
          children: [
               ...
               // { path: 'table', component: Table, name: '综合table' },
                ...
                { path: 'LoadExcel', component: LoadExcel, name: '模板下载' },
                { path: 'ShippingDateTable', component: ShippingDateTable, name: '船期大厅' },
                { path: 'exportTable', component: exportTable, name: '出口查询' },
                { path: 'Hello', component: Hello, name: '二维码' }
          ]
        },
       /* {
          path: '/excel',
